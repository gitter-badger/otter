...
(* OASIS_START *)
(* DO NOT EDIT (digest: 56eb3d642be72bee76a787b9161e2324) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/marklrh/otter";
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Api"; "Oauth"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "otter";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "otter_unix_lwt";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "unix";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "otter"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules = ["Oauth_unix"; "Api_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "otter";
                      lib_findlib_name = Some "unix_lwt";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "otter_example";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "otter";
                           InternalLibrary "otter_unix_lwt"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = true; exec_main_is = "otter_test.ml"})
            ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "£Þ\130Ñ¡]ºì'%\142I\138\158\001?";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
